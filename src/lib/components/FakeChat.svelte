	...
	export const messages = [
		{
			...
			text: 'ouviu falar dessa nova pesquisa?'
		},
		{
			user: 'pombaaveganaa',
			userColor: chatColors[1],
			text: 'sobre a gente, né?'
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'sim, o que achou?'
		},
		{
			user: 'pombaaveganaa',
			userColor: chatColors[1],
			text: 'do que vi, legal'
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'q perfil tu acha q tu é?'
		},
		{
			user: 'pombaaveganaa',
			userColor: chatColors[1],
		...
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'hard core, claro'
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'minha irmã é sugar crush, ctz'
		},
		{
			user: 'pombaaveganaa',
			userColor: chatColors[1],
			text: 'viu ali os perfis do tinder?'
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'são imagens gerada por IA'
		},
		{
			user: 'pombaaveganaa',
			userColor: chatColors[1],
			text: 'nossa, achei que fossem reais'
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
		...
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'pera, dx eu ver se @mathluffy_ topa entrar'
		},
		{
			user: 'pombaaveganaa',
			userColor: chatColors[1],
			text: 'meu duo @pdrcs tá terminando de comer e vem'
		},
		{
			user: 'gabiii98',
			userColor: chatColors[0],
			text: 'vou terminar de ver a pesquisa enquanto isso'
		},
		{
			user: 'mathluffy_',
