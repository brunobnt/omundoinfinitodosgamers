<script>
	...
	const chapters = [
		{ index: 1, href: '/choose-your-player', text: 'Choose your player' },
		{ index: 2, href: '/uma-grande-liga', text: 'Uma grande liga' },
		{ index: 3, href: '/vida-x-fantasia', text: 'Vida x Fantasia' },
		{ index: 4, href: '/o-lado-toxico', text: 'O lado tóxico' },
		{ index: 5, href: '/explorando-o-mapa', text: 'Explorando o mapa' },
...
<nav>
	<div id="nav-container">
		{#each chapters as c}
			...
			>
				{#if c.index <= 5}
					<div class="chapter-index">Capítulo {c.index}</div>
				{/if}
