...
<div>
	<span style:color>{formatPercentage(gender.cisMan)} Homem Cis</span>
	<span style:color style:opacity={0.65}>{formatPercentage(gender.cisWoman)} Mulher Cis</span>
</div>
...
<span>{formatPercentage(gender.others)} Não binário, trans, não declarado</span>
