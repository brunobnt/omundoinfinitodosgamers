<script>
	...
	import GameCategoriesChart from '$lib/components/charts/GameCategories.svelte';
	import GenderDistributionChart from '$lib/components/charts/GenderDistribution.svelte';
	import GamerMotivationsChart from '$lib/components/charts/GamerMotivations.svelte';
	import ContentTypesChart from '$lib/components/charts/ContentTypes.svelte';
	import ContentChannelsChart from '$lib/components/charts/ContentChannels.svelte';

	import profilesData from '$lib/data/profilesData.json';
...
<section id="profiles-details-section" class={`profile-${currentIndex}`}>
	...
	<Legend align="center" color="white">
		Estas imagens são meramente ilustrativas e não buscam estereotipar os perfis ou representar
		“personas”.
	</Legend>
	...
	<div id="profile-details-card" style:border-color={profile.color}>
		...
		>
			...
			<p>dos respondentes da pesquisa estão nesse perfil</p>
		</div>
		<div id="game-categories-wrapper" style:border-color={profile.color}>
			<h6>Categorias de jogos mais jogados</h6>
		...
		<div id="top-games-wrapper" style:border-color={profile.color}>
			<h6>Top 3 jogos mais jogados</h6>
			<div>
		...
		<div id="routine-items-wrapper" style:border-color={profile.color} style:color={profile.color}>
			<h6>Elementos que fazem parte da rotina</h6>
			<div>
				<div class="routine-item">
					<div>
						<p class="routine-item-percentage">{profile.routine.salgadinhos}</p>
						<img src={RoutineIcon1} alt="Salgadinhos" style:background-color={profile.color} />
					</div>
					<p class="routine-item-name">Salgadinhos</p>
				</div>
				<div class="routine-item">
					<div>
						<p class="routine-item-percentage">{profile.routine.comida}</p>
						<img src={RoutineIcon2} alt="Comida" style:background-color={profile.color} />
					</div>
					<p class="routine-item-name">Comida</p>
				</div>
				<div class="routine-item">
					<div>
						<p class="routine-item-percentage">{profile.routine.doces}</p>
						<img src={RoutineIcon3} alt="Doces" style:background-color={profile.color} />
					</div>
					<p class="routine-item-name">Doces</p>
				</div>
				<div class="routine-item">
					<div>
						<p class="routine-item-percentage">{profile.routine.musica}</p>
						<img src={RoutineIcon4} alt="Música" style:background-color={profile.color} />
					</div>
					<p class="routine-item-name">Música</p>
				</div>
			</div>
		</div>
		<div id="content-type-wrapper" style:border-color={profile.color}>
			<h6>Conteúdos que mais acessa</h6>
			<ContentTypesChart active={currentIndex} />
		</div>
		<div id="content-channels-wrapper" style:border-color={profile.color}>
			<h6>Canais que mais acessados</h6>
