<script>
	...
	import ProfilesDistribution from '$lib/components/en/charts/ProfilesDistribution.svelte';

	import PageTitle from '$lib/assets/images/en/c1-cover-title.png';
	import Display0 from '$lib/assets/displays/en/0.svelte';
	import Display1 from '$lib/assets/displays/en/1.svelte';
	import Display2 from '$lib/assets/displays/en/2.svelte';
	import Display3 from '$lib/assets/displays/en/3.svelte';
	import Display4 from '$lib/assets/displays/en/4.svelte';
	import Display5 from '$lib/assets/displays/en/5.svelte';
...
>
	<img id="profiles-cover-title" src={PageTitle} alt="Who are the gamers in 2023?" />
