...
<section id="profiles-image-section">
		...
		<div id="profiles-image-subsection-content">
			<div class="profiles-image-title">
				<Title type="component" align="center" color="black">
					The image of gamers in 2017 and in 2023
				</Title>
				<Paragraph align="center" color="black">
					Interact with the joystick to see how views of gamers have changed over this period
				</Paragraph>
			</div>
					...
					{#if year == 2017}
						<div class="content-container">
							<div class="comment-container">
								<Paragraph>
									“Here in Brazil it's like you're a freak in certain circles, people can't
									understand someone who likes computer games more than samba and soccer, for
									example.”
								</Paragraph>
								<h6 class="author">Male, 25 years old, Campo Grande, MS</h6>
							</div>
							<div class="comment-container">
								<Paragraph>
									“People judge me for 'wasting time' entertaining myself, when they 'waste time'
									watching soap operas and content that only serves to entertain them.”
								</Paragraph>
								<h6 class="author">Male, 25 years old, Sapucaia do Sul, RS</h6>
							</div>
						</div>
					{:else}
						<div class="content-container">
							<div class="comment-container">
								<Paragraph>
									“It's no longer a bum thing as they used to say, and today it's a profession.”
								</Paragraph>
								<h6 class="author">Male, 34 years old, Belém, PA</h6>
							</div>
							<div class="comment-container">
								<Paragraph>
									“It seems that gaming is now the norm. Everyone plays something, I don't see this
									old prejudice anymore.”
								</Paragraph>
								<h6 class="author">Male, 31 years old, Maringá, PR</h6>
							</div>
						</div>
					{/if}
				</div>
	...
	<div id="profiles-image-subsection-2">
		<div id="profiles-image-subsection-content">
			<div class="profiles-image-title">
				<Title type="component" align="center" color="black">
					The view of gamers has also changed, for the better
				</Title>
				<Paragraph align="center" color="black">
					Percentage of respondents who feel little or no prejudice towards gamers:
				</Paragraph>
			</div>
			<img src={GamerImageChart} alt="" />
			<div id="legend-wrapper">
				<Legend color="black">
					Our survey data also shows this difference: today, ⅔ of people who play games say they
					feel little or no prejudice towards gamers.
				</Legend>
			</div>
		</div>
	</div>
