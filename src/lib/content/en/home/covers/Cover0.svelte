	...
	>
		...
		>
			{#if mounted}
				...
				<p class="title-text lg:w-[27rem]" transition:fade={{ duration: 1000 }}>The Infinite</p>
				<p class="title-text justify-self-center lg:w-[16rem]" transition:fade={{ duration: 2000 }}>
					World
				</p>
				<p class="title-text lg:w-[27rem]" transition:fade={{ duration: 3000 }}>of Gamers</p>
			{/if}
		</div>
		<div class="flex flex-row justify-between">
			<div class="flex flex-col max-w-lg mr-20">
				<h3 class="text-lg mb-2 lg:text-3xl">A study of game consumers in Brazil</h3>
				<p class="text-sm lg:text-2xl">
					Dive into the complexity of this universe, get to know the profiles of gamers and
					understand how brands can be more relevant
				</p>
				<button
