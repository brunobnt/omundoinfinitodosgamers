...
<div id="content" class="crt">
	...
	<div class="footer right">
		<a id="design-by" href="http://odd.studio" target="_blank">Design by Odd.Studio</a>
		<hr />
	</div>
	<div id="subtitle">
	...
	<div id="title">
		...
		<span class="span2">Infinite</span><br />
		<span class="span3">World</span><br />
		<span class="span4">of</span>
		<span class="span5">Gamers</span>
	</div>

	<button id="start-button" on:click={start} transition:fade={{ duration: 200 }}> Start </button>
</div>
