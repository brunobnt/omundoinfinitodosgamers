<script>
	...
	import CoverSection from '$lib/content/chapter-5/Cover.svelte';
	import IntroSection from '$lib/content/chapter-5/Intro.svelte';
	import EsportsSection from '$lib/content/chapter-5/Esports.svelte';
	import ContentSection from '$lib/content/chapter-5/Content.svelte';
	import MoneySection from '$lib/content/chapter-5/Money.svelte';
	import SocialSection from '$lib/content/chapter-5/Social.svelte';
	import ConclusionSection from '$lib/content/chapter-5/Conclusion.svelte';
